...
- **Image-to-Grid (Desktop)**: Uses the **Gemini CLI** (Gemini 1.5 Pro/Flash) to scan Sudoku screenshots and convert them into digital grids with near-perfect accuracy via the **IMPORT** button.
...
- **Multi-Platform Consistency**: 
  ...
  - **Android**: Specialized file management with an **OVERWRITE** vs. **NEW FILE** workflow to bypass SAF limitations, ensuring reliable Save/Load reliability.
...
- **Gemini Extraction:** Ensure your Gemini CLI is logged in and using Gemini 1.5 models for the best results.
